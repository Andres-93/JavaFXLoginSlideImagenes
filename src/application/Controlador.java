...
public class Controlador {
	...
	public void initialize() {
		...
		pane1.setStyle("-fx-background-image: url('images/foto1.jpg')");
		pane2.setStyle("-fx-background-image: url('images/foto2.jpg')");
		pane3.setStyle("-fx-background-image: url('images/foto3.jpg')");
		pane4.setStyle("-fx-background-image: url('images/foto4.jpg')");
